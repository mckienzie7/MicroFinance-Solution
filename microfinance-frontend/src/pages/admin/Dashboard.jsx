      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <button 
              className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm font-medium text-gray-600 hover:text-gray-900 mt-1"
              ...
              <div className="overflow-hidden">
                <div className="px-3 py-4 sm:px-4 sm:py-5">
                  <div className="flow-root">
                    <ul className="-my-3 sm:-my-5 divide-y divide-gray-200">
                      {stats.recentLoans.map((loan) => (
                        <li key={loan.id} className="py-3 sm:py-4">
                          <div className="flex items-center space-x-2 sm:space-x-4">
                  ...
                  <div className="mt-4 sm:mt-6">
                    <a
                      href="#"
                      className="w-full flex justify-center items-center px-3 py-1.5 sm:px-4 sm:py-2 border border-gray-300 shadow-sm text-xs sm:text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
                    >
                      View all
                    </a>
                  </div>
